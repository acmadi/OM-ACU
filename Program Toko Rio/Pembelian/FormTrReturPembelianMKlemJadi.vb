...
Public Class FormTrReturPembelianMKlemJadi
    ...
    Private Sub setData()
        Try
            ...
            sql = " Select MB.KdBarang, NamaBarang, " & _
                  " Ukuran, Satuan, Harga, Qty, Qty_real, dr.Disc, " & _
                  " IfNull(( " & _
                  ...
                  " Join MsBarang MB On dr.KdBahanMentah = MB.KdBarang " & _
            ...
            Do While reader.Read
                ...
                gridBarang.Rows.Item(gridBarang.RowCount - 1).Cells("clmQty").Value = reader("Qty_real")
    ...
    Private Sub FormTrReturPembelianM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        gridBarang.Columns("clmQty").HeaderText = "Qty Retur ( Pack )"
    ...
    Function SaveReturDetail(ByVal flag As String)
        ...
        For i As Integer = 0 To gridBarang.RowCount - 1
            ...
            Dim Qty_real = gridBarang.Rows.Item(i).Cells("clmQty").Value
            ...
            If Qty_real <> Stok Then
                statusFaktur = 2
            End If

            If Qty_real <> 0 Then
                If flag = 1 Then
                    StockBarang(Qty_real, OP, harga, KdBarang, Attribute, Trim(txtID.Text), "Form Retur")
                End If
    ...
    Private Sub gridBarang_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles gridBarang.CellEndEdit
        Try
            ...
            End If
            gridBarang.CurrentRow.Cells("clmDisc").Value = disc
            gridBarang.CurrentRow.Cells("clmQty").Value = Val(qty)
            gridBarang.CurrentRow.Cells("clmHarga").Value = FormatNumber(Val(harga), 0)
    ...
    Private Sub cmbfaktur_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbPB.SelectedIndexChanged
        If cmbPB.SelectedIndex <> 0 Then
            sql = " SELECT MB.KdBarang, NamaBarang, Ukuran, " & _
                  ...
                  " JOIN MsBarang MB ON dp.KdBahanMentah = MB.KdBarang " & _
                  " JOIN Mssupplier MT ON MT.Kdsupplier = pb.KdSupplier " & _
