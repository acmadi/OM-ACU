...
Public Class FormProduksi
    ...
    Private Sub viewAllData(ByVal cr As String, ByVal opt As String)
        sql = " select KdProduksi 'No. Produksi', DATE_FORMAT(TanggalProduksi,'%d %M %Y') Tanggal, " & _
              ...
              " WHEN StatusPayment = 1 THEN 'Sudah Dibayar' End 'Upah Produksi' " & _
        ...
        If opt <> "" Then
            ...
            End If
        End If
        sql &= " Order By StatusProduksi asc,TanggalProduksi Desc "
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Try
            open_subpage("FormProduksiManagement")
            viewAllData("", "")
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            If DataGridView1.RowCount <> 0 Then
                Dim selected_cell = DataGridView1.CurrentRow.Cells("No. Produksi").Value
                open_subpage("FormProduksiManagement", selected_cell)
                viewAllData("", "")
            Else
            ...
            If (DataGridView1.RowCount) Then
                If DataGridView1.CurrentRow.Cells("Status Produksi").Value = "New" Then
                    ...
                    If MsgBox("Anda yakin ingin menghapus produksi produksi ini?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Confirmation") = MsgBoxResult.Yes Then
                        execute_update("delete from trProduksi where  KdProduksi = '" & selected_cell & "' And StatusProduksi = 0 ")
